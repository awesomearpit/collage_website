...
$sql="insert into mocktest ( m_name,sub_name,tea_name,branch,file,download,date ) values ('".$mname."','".$sname."','".$tname."','".$branch."','".$tt."','".$download."','".$date."')";
...
$conn->close();
header('Location:teacher_mocktest.php');
